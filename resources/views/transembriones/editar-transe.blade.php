                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input name="COD_TRANS_EMBRION" value="{{$transembrion->COD_TRANS_EMBRION}}" placeholder="" id="COD_GANADO" class="form-control" type="text" value="{{$transembrion->COD_TRANS_EMBRION}}"> <br />
                                </div>
                                <div class="form-group">
