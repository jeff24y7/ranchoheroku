...
<x-app-layout>
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Registro de Transferencia de esperma</h1>
            </div>
            <div class="col-sm-6">
                    ...
                    <table id="TB" class="table table-bordered table-hover US">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $transesperma->COD_ESPERMA }}</td>
                                <td>{{ $transesperma->NUM_PAJILLA }}</td>
                                <td>{{ $transesperma->RAZ_TORO_DONADOR }}</td>
                                <td>{{ $transesperma->NOM_GANADO }}</td>
                                <td>{{ $transesperma->IND_FECUNDACION }}</td>
                                <td style="width: 20%">{{ $transesperma->FEC_REGISTRO }}</td>
                                <td style="width: 10%;"><a class="btn btn-warning" href="{{url('transesperma/' . $transesperma->COD_TRANS_ESPERMA . '/edit')}}">Editar</a></td>
                                <td style="width: 10%;">
            ...
            <form method="post" role="form">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <h5>Agregar transferencia de esperma </h5><br />
                        <h9>Campos oligatorios <span style="color: red;"> * </span></h9><br />
                        <h12> </h12><br />

                        <div class="form-group">
                            <label><span style="color: red;"> * </span>CÓDIGO ESPERMA</label>
                            <select name="COD_ESPERMA" class="form-control">
                                <option value="" selected disabled>Seleccione una pajilla</option>
                                @foreach ($datos["detalles"] as $transesperma)
                                <option value="{{$transesperma->COD_ESPERMA}}">{{$transesperma->NUM_PAJILLA}}</option>
                                @endforeach
                            </select>
                        </div>
