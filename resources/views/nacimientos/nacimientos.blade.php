                            ...
                            <div class="card-body">
                                <table id="TB" class="table table-bordered table-hover US">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$nacimiento->COD_NACIMIENTO_EMBRION}}</td>
                                            <td>{{$nacimiento->COD_REGISTRO_GANADO}}</td>
                                            <td>{{$nacimiento->Ternero}}</td>
                                            <td>{{$nacimiento->NOM_GANADO}}</td>
                                            <td>{{ \Carbon\Carbon::parse($nacimiento->FEC_NACIMIENTO)->format('d/m/Y')}}</td>
                                            <td colspan="2">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="COD_GANADO" id="COD_GANADO" class="form-control" required>
                                            ...
                                            @foreach ($datos["vacasrecienp"] as $vrecienp)
