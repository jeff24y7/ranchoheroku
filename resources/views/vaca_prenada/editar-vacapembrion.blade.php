                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input name="COD_VACA_PRENADA" value="{{$vacaprenadaembrion->COD_PRENADA_EMBRION}}" placeholder="" id="COD_VACA_PRENADA" class="form-control" type="text" disabled> <br />
                                </div>
                                <div class="form-group">
                                    <label><span style="color: red;"> * </span>CÓDIGO EMBRION</label>
                                    <input name="COD_EMBRION" value="{{$vacaprenadaembrion->COD_EMBRION}}" placeholder="" id="COD_EMBRION" class="form-control" type="text" disabled> <br />
                                </div>
                                <div class="form-group">
