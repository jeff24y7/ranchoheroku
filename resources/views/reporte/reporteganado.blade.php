...
<head>
	...
	<title>Reporte Compra Ganado</title>
	<style type="text/css">
		.clearfix:after {
			content: "";
			display: table;
	...
	<main>
		<div id="details" class="clearfix">
			<div id="Reporte">
				...
				<h2 class="name">Reporte de Compra de Ganado</h2>
		...
		<table  id="table" class="">
			...
			<tbody>
				...
				<tr>
					<td>{{ $dato->COD_COMPRA_GANADO}}</td>
					<td>{{ $dato->COD_REGISTRO_GANADO}}</td>
					<td>{{ $dato->NUM_ARETE}}</td>
					<td>{{ $dato->NOM_GANADO}}</td>
					<td>{{ \Carbon\Carbon::parse($dato->FEC_COMPRA)->format('d/m/Y')}}</td>
				</tr>
