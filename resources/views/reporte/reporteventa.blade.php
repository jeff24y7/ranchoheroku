...
<head>
	...
	<title>Reporte Venta Ganado</title>
	<style type="text/css">
		.clearfix:after {
			content: "";
			display: table;
	...
	<main>
		<div id="details" class="clearfix">
			<div id="Reporte">
				...
				<h2 class="name">Reporte de Venta de Ganando</h2>
		...
		<table  id="table" class="">
			...
			<tbody>
				...
				<tr>
					...
					<td>{{ $dato->NOM_GANADO}}</td>
					<td>{{ $dato->DIR_LUGAR}}</td>
					<td>{{ $dato->PRE_VENTA}}</td>
					<td>{{ \Carbon\Carbon::parse($dato->FEC_VENTA)->format('d/m/Y')}}</td>
				</tr>
