                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Preñadas por monta</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">Editar vaca Preñada</h3>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input name="COD_VACA_PRENADA" value="{{$vacaprenadamonta->COD_PRENADA_MONTA}}" placeholder="" id="COD_VACA_PRENADA" class="form-control" type="text" disabled> <br />
                                </div>
                                <div class="form-group">
                                    <label><span style="color: red;"> * </span>Código Monta</label>
                                    <input name="COD_EMBRION" value="{{$vacaprenadamonta->COD_MONTA}}" placeholder="" id="COD_EMBRION" class="form-control" type="text" disabled> <br />
                                </div>
                                <div class="form-group">
